...
\begin{frame}
	...
	\begin{block}{Esercizio 1: soluzione}
		\begin{figure}[!htbp]
			...
			\caption{1. Invio indirizzo, 2. Estrazione del dato, 3. Invio del dato}
%			\label{}
		\end{figure}
	\end{block}
\end{frame}
...
\begin{frame}
	...
	\begin{block}{Esercizio 1: soluzione}
		Per calcolare il tempo di una lettura è necessario scomporre l'operazione di lettura in tre parti e calcolare la durata di ogni operazione:
		\begin{enumerate}
			\item Inviare l'indirizzo della locazione di memoria sul BUS degli indirizzi
		\end{enumerate}	
	\end{block}
\end{frame}
