...
\subsection[PCIe e USB]{PCIe e USB}
\begin{frame}
...
\subsubsection[USB]{USB}
\begin{frame}
	\frametitle{USB}
	  
	\begin{block}{USB}
		\textbf{USB}, d'altra parte, è un bus più versatile progettato per collegare dispositivi esterni, come mouse, tastiere, stampanti, unità flash USB e molti altri. È caratterizzato da un'ampia compatibilità, facilità d'uso e funzionalità plug-and-play.\\~\\
