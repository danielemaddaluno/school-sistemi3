...
\begin{frame}
	\frametitle{La RAM: valutare le prestazioni di una memoria}
	
	\begin{block}{}
		Altri parametri per valutare le prestazioni di una memoria sono:
		\begin{itemize}
			\item \textbf{Latenza}: il tempo necessario, in cicli macchina dell’FSB, affinché un dato venga letto dalla memoria
			\item \textbf{Banda di trasferimento dati}: la quantità di informazioni al secondo che vengono trasmesse dalla memoria	
		\end{itemize}
