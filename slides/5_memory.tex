...
\begin{frame}
	...
	\begin{block}{}
		...
		\begin{columns}			
			\column{0.5\linewidth}
			La memoria è organizzata in \textbf{celle}.
			L’\textbf{indirizzo di memoria} di ciascuna cella è definito dalla posizione relativa della cella rispetto alla prima cella.\\~\\
			Dato $n$: ampiezza del BUS degli indirizzi, ovvero il numero di fili conduttori sul BUS degli indirizzi, posso calcolare:
			\begin{itemize}
