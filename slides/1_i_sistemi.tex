...
\begin{frame}
	\frametitle{Classificazione dei sistemi}
	\begin{block}{Classificazione dei sistemi}
		Sulla base di tali osservazioni possiamo classificare un sistema come:
		\begin{itemize}
...
\begin{frame}
	...
	\begin{block}{Variante o invariante}
		abc
	\end{block}
\end{frame}

\subsubsection[Discreto o continuo]{Discreto o continuo}
\begin{frame}
	\frametitle{Discreto o continuo}
	\begin{block}{Discreto o continuo}
		abc
	\end{block}
\end{frame}
