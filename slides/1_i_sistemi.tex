...
\subsection[Il sistema computer]{Il sistema computer}
\begin{frame}
...
\subsubsection[La macchina di Turing]{La macchina di Turing}
\begin{frame}
...
\subsubsection[Il computer]{Il computer}
\begin{frame}
	...
	\begin{block}{Il computer}
		...
		\begin{columns}						
			...
			\begin{figure}[!htbp]
				\centering 
				\includegraphics[width=0.7\linewidth]{images/1_i_sistemi/microcontroller.jpeg}
				%\caption{}
			\end{figure}
			...
			\begin{figure}[!htbp]
				\centering
				\advance\leftskip-0.5cm
				\includegraphics[width=1.0\linewidth]{images/1_i_sistemi/microcontroller.png}
				%\caption{}
			\end{figure}
