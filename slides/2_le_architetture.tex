...
\begin{frame}
	...
	\begin{figure}[!htbp]
		\centering 
		\includegraphics[width=1.0\linewidth]{images/2_le_architetture/demorgan_1.jpeg}
%		\caption{Le tabelle di verità}
	\end{figure}
...
\begin{frame}
	...
	\begin{figure}[!htbp]
		\centering 
		\includegraphics[width=1.0\linewidth]{images/2_le_architetture/demorgan_2.png}
%		\caption{Le tabelle di verità}
	\end{figure}
\end{frame}
