...
\begin{frame}
	...
	\begin{block}{Il clock}
		Il \textbf{clock} è un esempio di generatore di segnali che viene utilizzato per \textit{sincronizzare} e \textit{coordinare} le operazioni all'interno di un computer, produce un \textbf{segnale periodico} con forma di \textbf{onda quadra}.
	\end{block}
