...
\definecolor{CpuPink}{RGB}{248,215,171}
\definecolor{CpuGreen}{RGB}{181,202,122}
\definecolor{CpuRed}{RGB}{236,178,153}
\definecolor{CpuBlue}{RGB}{158,197,222}
\definecolor{CpuYellow}{RGB}{252,224,62}
...
\include{0_intro}
\include{1_i_sistemi}
\include{2_elettronica}
\include{3_architetture}
\include{4_cpu}
\include{5_memory}
\include{6_bus}
\include{7_pipeline}
\include{9_networking}
\include{credits}
